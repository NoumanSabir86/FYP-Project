                  ...
                  <div class="my-4 mt-12 -mx-2 lg:flex items-start pr-96 ">
                    ...
                    <div class="lg:px-2 lg:w-1/2 ">
                      <div id="PaymentForm">
                        ...
                        <div>
                          <a href="#">
                            <button class="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-800 rounded-sm shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none">
                              <svg
                                aria-hidden="true"
                                data-prefix="far"
